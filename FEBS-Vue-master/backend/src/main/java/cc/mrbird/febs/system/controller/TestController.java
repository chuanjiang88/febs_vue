...
import cc.mrbird.febs.common.forest.ForestProxyClient;
import cc.mrbird.febs.system.domain.ImageInfoDTO;
...
//    @Autowired
//    private ForestProxyClient forestProxyClient;
     ...
     * 读取图片信息
     */
//    @PostMapping("readImageInfo")
//    public String readImageInfo(@RequestBody ImageInfoDTO dto) throws FebsException {
//        try {
//            String retStr = forestProxyClient.simpleRequest(dto.getImageBase64Str());
//            return retStr;
//        } catch (Exception e) {
//            log.error(message, e);
